...
export const bookingSettings = {
  ...
  estimatedItemDurationMinutes: {
    ...
    'aroma-120': 120,
    'aroma-pkg-ear': 120,
    'aroma-pkg-cupping': 120,
    'aroma-pkg-guasha': 120,
    'aroma-pkg-foot': 120,
    'thai-60': 60,
    'thai-90': 90,
    'thai-120': 120,
...
export const ui = {
  en: {
    ...
    demoAvailabilityNote: 'Estimated with 4 therapists, sample bookings, and a 15-minute turnaround. Replace with real shop data before launch.',
  ...
  zh: {
    ...
    demoAvailabilityNote: '目前以 4 位按摩师、示例预约和 15 分钟整理时间估算。正式启用前将替换为店铺真实资料。',
